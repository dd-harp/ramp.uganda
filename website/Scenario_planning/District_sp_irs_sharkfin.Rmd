...
valsf <- get_XH(fitted_mod[[1]])
with(valsf, plot(fitted_mod[[1]]$outputs$time/365+FirstYear, true_pr, ylab = "PR",lwd=2, xlab = "Time", main=unique(data_list[[1]]$district_name), type = "l", ylim = c(0,1), col="darkred"))
...
mod_irs <- setup_irs(mod_file, effectsizes_name = "simple", coverage_name = "func", coverage_opts = list(mx=1, trend_par = multi4))
