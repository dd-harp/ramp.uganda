...
profile_itn = function(i, model_list, data_list){
 ...
 # computing itn _effect size for every three years
  ...
  itn_1 <- itn_time[[i]][(length(itn_time[[i]])-1)]
  itn_2 <-itn_time[[i]][(length(itn_time[[i]])-2)]
...
# Save to CSV
write.csv(malaria_itn_eff, "../data/malaria_itn_eff_2023.csv", row.names = FALSE)
```
