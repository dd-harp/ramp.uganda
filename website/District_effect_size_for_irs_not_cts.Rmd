...
```
Get fitted models to pfpr data for all the irs_district when not applied continious
...
eir_files_irs <- eir_files[matched_indices]#matched_indices]
```
