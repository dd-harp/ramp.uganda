...
Adaptive malaria control is a structured, iterative approach to developing policy using a bespoke inferential system called **r**obust **a**nalytics for **m**alaria **p**olicy (RAMP).
