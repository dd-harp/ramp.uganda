...
```{r, fig.height=3, fig.width=12, echo=F}
hist(sf_max$avg_tpr)
points(seq(0.0, 0.95, by=0.05), rep(0, 20), pch = 15, col = rev(plasma(20)))
```

```{r, fig.height=12, fig.width=12, echo=F, eval=F}
...
hist(sf_max$avg_pfpr)
points(seq(0.0, 0.95, by=0.05), rep(0, 20), pch = 15, col = rev(plasma(20)), main = "TPR")
```
